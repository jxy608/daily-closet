...
import LaundryDemo from "../../../assets/laundry-demo.png";
...
const Welcome = ({ userId, handleLogout }) => {
  ...
  const content = [
    ...
    "As a new user to Daily Closet, after inputting your user settings, you will upload photos of your clothes, which you can then categorize and adjust based on the appropriate temperature range to wear the clothing item in.",
    ...
    "On the homepage, you’ll get a daily outfit recommended to you based on the temperature and weather in your location. If you don’t like the outfit generated, you can click the X to get a new one recommended to you, or hit the check to accept. Daily Closet keeps track of the number of times you’ve declined to wear certain articles of clothing, and will recommend you sell or donate clothes you don’t wear often to free up closet space! (See the recycle button on the closet page for more details.)",
    "Daily Closet also keeps track of how many times you've worn your clothes, and lets you know at a glance when laundry day is coming up! You can also view which clothes are in the laundry, and can wash them to reset the number of wears through the laundry menu.",
